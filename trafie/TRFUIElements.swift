...
// MARK:- Colors
// MARK: Pallete
let CLR_TRAFIE_RED = UIColor(rgba: "#DE0B0B")
...
let CLR_NOTIFICATION_GREEN = UIColor(rgba: "#8CB56B" )
let CLR_NOTIFICATION_RED = UIColor(rgba: "#DB0F13")
let CLR_NOTIFICATION_ORANGE = UIColor(rgba: "#FA6900")
let CLR_NOTIFICATION_YELLOW = UIColor(rgba: "#F8CA00")
